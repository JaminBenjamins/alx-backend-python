...
class TestGithubOrgClient(unittest.TestCase):
    ...
    @patch('client.get_json', return_valuee={"payload": True})
    ...
    def test_public_repos_url(self):
        """
        Test GithubOrgClient's _public_repos_url
    ...
    def test_public_repos(self, mock_repo):
        """Test GithubOrgClient's public repo method"""
        with patch.object(GithubOrgClient,
                            '_public_repos_url',
            ...
            for index in range(3):
                self.assertIn(mock_repo.return_value[index]['name'], test_repo)
    ...
    def test_has_license(self, repo, license_key, expected):
        ...
        Args:
            ...
            license_key(str): license in repo dict
        """
